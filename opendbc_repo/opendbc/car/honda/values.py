...
class CAR(Platforms):
  ...
  HONDA_FIT_4G = HondaBoschPlatformConfig(
    ...
    CarSpecs(mass=2000 * CV.LB_TO_KG, wheelbase=2.53, wheelbase=2.53, steerRatio=15.2, centerToFrontRatio=0.39, tireStiffnessFactor=0.5, minSteerSpeed=23. * CV.KPH_TO_MS),
    {Bus.pt: 'honda_bosch_radarless_generated'},
    flags=HondaFlags.BOSCH_RADARLESS,
  )
